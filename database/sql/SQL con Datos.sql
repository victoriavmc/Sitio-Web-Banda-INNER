...
VALUES (8, '2024-10-10', 'Flamaaaaa!!!', 22, 13, NULL),
(
    9,
    '2024-10-10',
    'Estaba pensando ir, vos ya fuiste a alguno de sus shows?',
    24,
    15,
    NULL
  ),
(
    10,
    '2024-10-10',
    'El mio mas copado compa jsjsjs',
    25,
    13,
    25
  ),
(
    12,
    '2024-10-10',
    'Tocan todas generalmente, yo les vi la otra vez en el show *Anterior nomas*. Y pude saludarlos, unos capos, menos el negro..',
    27,
    15,
    NULL
  ),
(
    13,
    '2024-10-10',
    'Ese se difumino en el show cada que apagan las luces... jsjs',
    28,
    15,
    NULL
  ),
(
    18,
    '2024-10-10',
    'NOOOO MUY BUENOOOOOO!!!',
    33,
    13,
    NULL
  ),
(19, '2024-10-10', 'Me quedo mortal <3', 36, 13, NULL),
(20, '2024-10-10', 'F', 37, 16, NULL),
(21, '2024-10-17', 'Jaja verdad xdxdxd', 45, 17, NULL),
(22, '2024-10-17', '', 46, 13, 79),
(
    23,
    '2024-10-17',
...
(24, '2024-10-17', 'La prox sera..', 48, 16, NULL),
(
    25,
    '2024-10-17',
    'Donde se hacen sus tatuajes?',
    49,
    19,
    NULL
  ),
(
    26,
    '2024-10-17',
    'Nunca responden, re alpedo esto... ^_____^',
    50,
    19,
    NULL
  );
...
(
    6,
    '2024-10-10',
    '¡LA BANDA INNER ANUNCIA SU PRÓXIMO ÁLBUM!',
    'La banda INNER ha confirmado el lanzamiento de su nuevo álbum titulado \'Ritmos del Futuro\', programado para el 15 de noviembre. Este álbum incluirá colaboraciones con artistas destacados y promete una mezcla única de géneros.',
    2,
    6
  ),
(
    7,
    '2024-10-11',
    '¡GIRA MUNDIAL DE LA BANDA INNER COMIENZA EN ENERO!',
    'Tras el éxito de su último tour, la banda Inner ha anunciado una nueva gira mundial que comenzará en enero de 2025. Los fanáticos podrán disfrutar de sus canciones en vivo en ciudades de todo el mundo, con fechas y lugares que se anunciarán próximamente.',
    2,
    7
  ),
(
    ...
    '¿Alguien hace dibujos, covers o algo relacionado con Inner? ¡Me encantaría ver lo que han creado! Yo hice:',
    1,
    19
  ),
(
    15,
    '2024-08-10',
    'Próxima Gira: ¿Quién irá al concierto?',
    'La banda acaba de anunciar su nueva gira, y estoy súper emocionado. Ya compré mis boletos para el show en *Doxeado*. ¿Alguien más va a ir? ¿Qué canciones esperan que toquen en vivo, todas?',
    1,
    23
  ),
(
...
(
    ...
    'He sido fan de la banda por mucho tiempo, llegue a cruzarme con todos varias veces, y últimamente me ha molestado la actitud del guitarrista. Siento que no trata bien a los fans y eso afecta la imagen del grupo. Ojalá pueda cambiar su comportamiento y volver a ser un ejemplo positivo..',
    1,
    35
  ),
(
    ...
    '¡¿Quieren conocer a los artistas de la banda?!\r\nEsta es tu oportunidad de conectarte directamente con los miembros de la banda. Si tienes alguna pregunta que siempre quisiste hacerles, ¡este es el momento! Comenta en este post y los artistas responderán desde sus cuentas oficiales. Ya sea sobre su música, influencias, o sus planes a futuro, ¡no te quedes con la duda!',
    1,
    39
  ),
(
...
(
    ...
    '¡Gran noticia! Inner ha sido destacado en la revista Rev, una de las publicaciones más influyentes de la escena musical argentina. En un apartado especial, hablamos sobre nuestro álbum Journey, un viaje sonoro que refleja nuestras experiencias y emociones a lo largo de este último tiempo.\r\nEn Journey, exploramos diversos estilos y sonidos que nos representan, y estamos emocionados de compartirlo con ustedes. No se pierdan la entrevista completa y los detalles sobre cómo este álbum ha sido una parte fundamental de nuestro crecimiento como banda.\r\n ¡Agradecemos a Rev por esta increíble oportunidad! Pueden leer el artículo completo en su sitio web o en su próxima edición impresa. ¡Gracias por el apoyo!',
    2,
    41
  ),
(
    ...
    '2024-10-10',
    'INNER EN RIZE UP!',
    'La banda Inner de Buenos Aires ha sido destacada por Rize UP! Prensa debido al lanzamiento de su primer álbum de larga duración, titulado \"Journey\". Este trabajo incluye nueve temas que fusionan introspección y poderosas armonías dentro de las diferentes ramas del Metal, capturando la atención de los seguidores del género con su estilo cargado de groove.\r\n\r\nEn la publicación, Rize UP! Prensa resalta la profundidad de este proyecto, que lleva al oyente en un viaje interno acompañado de riffs pesados y letras intensas. \"Journey\" ha recibido gran recepción y se espera que impulse a Inner a nuevos niveles en la escena musical metalera.\r\n\r\nEste álbum fue lanzado en agosto de 2021 y ya está disponible en plataformas como YouTube, Spotify y Apple Music, donde los fans pueden disfrutar de la propuesta sonora de Inner.',
    2,
    42
  );
...
VALUES (1, 'VictoriaV', 'MC', '2002-02-16', 'Mujer', 1, 9),
(
    2,
    'Victoria Valentina',
    'Maidana Corti',
...
(3, 'SantiN', 'Aranda', '2004-06-14', 'Hombre', 3, 9),
(
    4,
    'Santiago Nicolas',
    'Aranda',
...
VALUES (1, 'Activo', 'No', NULL, NULL, 1),
(2, 'Activo', 'No', NULL, NULL, 2),
(3, 'Activo', 'No', NULL, NULL, 3),
(4, 'Activo', 'No', NULL, NULL, 4),
(5, 'Activo', 'No', NULL, NULL, 5),
(6, 'Activo', 'No', NULL, NULL, 6),
(7, 'Activo', 'No', NULL, NULL, 7),
(8, 'Activo', 'No', NULL, NULL, 8),
(9, 'Activo', 'No', NULL, NULL, 9),
(10, 'Activo', 'No', NULL, NULL, 10),
(11, 'Activo', 'No', NULL, NULL, 11),
(12, 'Activo', 'No', NULL, NULL, 12),
(13, 'Activo', 'No', NULL, NULL, 13),
(14, 'Activo', 'No', NULL, NULL, 14),
(15, 'Activo', 'No', NULL, NULL, 15),
(16, 'Activo', 'No', NULL, NULL, 16),
(17, 'Activo', 'No', NULL, NULL, 17),
(18, 'Activo', 'No', NULL, NULL, 18),
(19, 'Activo', 'No', NULL, NULL, 19);
...
VALUES (
    1,
    'img/rEilSSDCWmJ5mJw9PbJTAZ8VwPrprQ7JtkyWM8Dm.jpg',
    '2024-10-08',
    'No'
  ),
(
    2,
    'img/Vx5Vup6j7O2634SNLCEV8YwtAew4cwHMvGOvvsET.jpg',
    '2024-10-08',
    'No'
  ),
(
    3,
    'img/Sn4BplVT3g99yH9Mq7klNjzXdcwulCBffEttN45T.png',
    '2024-10-08',
    'No'
  ),
(
    4,
    'img/qgHACDepdbtFJbY8pnaw1kM9uimch296bRvVJa6m.jpg',
    '2024-10-08',
    'No'
  ),
(
    5,
    'img/CncyJjlW0KzT5wb71KeRQw3lVBmtNCy9anpktB9x.jpg',
    '2024-10-08',
    'No'
  ),
(
    7,
    'img/uDfTfKZaOPSKb6hZGU9q8jmewxNF40ccq6ECYXxr.jpg',
    '2024-10-08',
    'No'
  ),
(
    8,
    'img/C9m0iYCPN7gCKTwyktnYIeVECpS0yZxDOn9PpHie.jpg',
    '2024-10-08',
    'No'
  ),
(
    9,
    'img/Rh2514JTtsTicyYztrvBFemsdVNb0W25GUXUGI3F.png',
    '2024-10-09',
    'No'
  ),
(
    10,
    'img/zst5wi5VISilUXykfX5yrhtQAJTMjdigpjp1GYDj.jpg',
    '2024-10-10',
    'No'
  ),
(
    11,
    'img/XLmeRxjD9Z3gB2cZUeWFlMl9UEMzsn4h4vqawww7.jpg',
    '2024-10-10',
    'No'
  ),
(
    12,
    'img/lsqiPF9Mol8c265gcrLER0zklXo3Oz2R2woDPigx.jpg',
    '2024-10-10',
    'No'
  ),
(
    13,
    'img/9QBoPNZYGrx1NgHDaoFFh01J9HpuLkCw23ILoClT.jpg',
    '2024-10-10',
    'No'
  ),
(
    14,
    'img/rEwuOvauIPPEwS0VhR9gOXmmT4SpNbCxNuo8R7Xm.jpg',
    '2024-10-10',
    'No'
  ),
(
    25,
    'img/op9ZZegaflQewhDabC0LEd0ChIRJXMchCNuCX7oc.jpg',
    '2024-10-10',
    'No'
  ),
(
    37,
    'img/G7TtO4hkih8R0qZPmq6xKhHZ6VMil6P6IKgllVAJ.jpg',
    '2024-10-10',
    'No'
  ),
(
    40,
    'img/QkUyrj4FatGTGGCVgKIe2MgFGSD2mdKBoLDLeo69.jpg',
    '2024-10-10',
    'No'
  ),
(
    41,
    'img/TQbPLSGY4Z05VbhGfUcijumkdmc5pmPmPd4wxQuh.jpg',
    '2024-10-10',
    'No'
  ),
(
    42,
    'img/kaaQBNU9QLEi6A95Bs56oRA0WhqGMa5ddbumVqwS.jpg',
    '2024-10-10',
    'No'
  ),
(
    46,
    'img/Xg1OQZDdfwc4DEfPceDtOqfe9TadURsftEFqSzkL.jpg',
    '2024-10-10',
    'No'
  ),
(
    47,
    'img/fuuOuAjFzNecibYwi1w4cZDiObf0s6dDLR1eXxce.jpg',
    '2024-10-10',
    'No'
  ),
(
    48,
    'img/6y5yDbzdZQCiu1qF1zJjc95tBPVXQiAuoFSJcShe.jpg',
    '2024-10-10',
    'No'
  ),
(
    49,
    'img/asOqDLWsirZpz7ET3xDpYqFW4mvbRu051MJftZI3.jpg',
    '2024-10-10',
    'No'
  ),
(
    53,
    'img/ebnkuFPUVip2acw6wJb6x7xN2gBTYATLH84GXEvM.jpg',
    '2024-10-10',
    'No'
  ),
(
    54,
    'img/UA65XXn3OxGZc47BkQFGUJXOgnHi1EYyhZxCQIoK.png',
    '2024-10-10',
    'No'
  ),
(
    55,
    'img/g2SvLJbBwAi4UhU8ms4EEfBeXL8Zbpz797a0TKat.jpg',
    '2024-10-10',
    'No'
  ),
(
    57,
    'img/1LiQOreUV1aNDBQZZliEcAFcXjPlQwyCAS2jKGOt.png',
    '2024-10-10',
    'No'
  ),
(
    58,
    'img/X1XCpWmiUCUwzbgFCRRmJlqiEOJyPcE4afPMtLy3.jpg',
    '2024-10-12',
    'No'
  ),
(
    59,
    'img/ng0EYA6EJy2zS5W98oqdO6fxCFl0gSmD19cXDgRZ.jpg',
    '2024-10-12',
    'No'
  ),
(
    60,
    'img/PFSymQuQbM14DqUerpkp7ow5FOz9OauKatReYw5s.jpg',
    '2024-10-12',
    'No'
  ),
(
    61,
    'img/ckoV8Fl1DZApPTnIbJyXlhHrGovJMFE3OqZMKZea.jpg',
    '2024-10-12',
    'No'
  ),
(
    62,
    'img/ea1fEKu4ydC7VZk0PqYyacDrIEt5S8Fxx4bEzJp2.jpg',
    '2024-10-12',
    'No'
  ),
(
    63,
    'img/J9HwHMYdyVOF9BsAndp8l1WwFoIoXHARbb5nQ6JA.jpg',
    '2024-10-12',
    'No'
  ),
(
    64,
    'img/jhh3awECWsc2rhjb1YhVpIpOm3tIS1jeiSohAWW1.jpg',
    '2024-10-12',
    'No'
  ),
(
    65,
    'img/YRROhImPEEjQRCHxm5AVnAq7Kv0bYSwNNM0E4xM0.jpg',
    '2024-10-13',
    'No'
  ),
(
    66,
    'img/sN22JBGeJi0Ylmt73QLsqez8AUolpqx9mD09ZMkZ.jpg',
    '2024-10-13',
    'No'
  ),
(
    79,
    'img/M6ToaIkUudhqaylZcsUvP1Yi01fH6nhSQZJ0A6r6.jpg',
    '2024-10-17',
    'No'
  ),
(
    80,
    'img/djD2ueZj75CQEf6yJXX3JvQsjsVrt3xzhfShXcGR.jpg',
    '2024-10-17',
    'No'
  ),
(
    81,
    'img/lYuEo3be2DVt9WEdBbAVEwuyCl33tmHmWJzSk6QZ.jpg',
    '2024-10-17',
    'No'
  );
...
(
    7,
    'https://www.instagram.com/arandanosantiago/',
    '4arandano'
  );
...
;
INSERT INTO `show`
VALUES (1, '2023-09-16 19:00:00', 'Inactivo', NULL, 1, 13, 1),
(2, '2023-09-29 20:00:00', 'Inactivo', NULL, 1, 12, 2),
(3, '2024-10-14 21:00:00', 'Inactivo', NULL, 1, 11, 3),
(4, '2024-10-21 18:00:00', 'pendiente', NULL, 1, 10, 1);
...
(24, 'Ciudad Autónoma de Buenos Aires', 'Argentina');
...
VALUES (
    1,
    'victoriavmc',
    '$2y$12$WB2VuGYA/M/gPP3YYgsK2uBg6PW3.pnegYazaVZ3IM3l17SQwAFci',
    NULL,
...
(
    2,
    'amuquy',
    '$2y$12$ERVNaYyUVzJpJ0C1kH5Si.9H9gReKAtTB3RAyLOiXuWWgnAo2Du5S',
    NULL,
    'victoriavmaidanacortitrabajos@hotmail.com',
    2
  ),
(
    3,
    'santi',
    '$2y$12$/v3KL0NUYa9NaaLpLx09lOWmCpUKck2mr06SXSEHTo2SbxqqCn.5y',
    NULL,
...
(
    4,
    'arandano',
    '$2y$12$Qr7y9VnO0duYEGQ.qY7pTOnIDV75Tj2.vI3SSpY1nBHSH3nbgYzLW',
    NULL,
    'santi.aranda@example.com',
    2
  ),
(
    5,
    'staffone',
    '$2y$12$y7Pf/nwcN86.r6avPDbc5uxsiBD1c/VR/2wYHX4F6LDd5GK3ZyJzC',
    NULL,
    'staff1@example.com',
    2
  ),
(
    6,
    'stafftwo',
    '$2y$12$kcqmhzRU5qqVAf/lVFPOo.OG2lpkp.OOfRGewIqfZKAAeYc8JAuFy',
    NULL,
    'staff2@example.com',
    2
  ),
(
    7,
    'staffthree',
    '$2y$12$sM6bhbLaXt0JeU6ZyXPQYeVM8cGEH4WhPoKcexE/0b9/8c0uTQ9Ta',
    NULL,
    'staff3@example.com',
    2
  ),
(
    8,
    'fanone',
    '$2y$12$5yBSUlq82ETXqfHtKbu3GuKKhdDDeU9Zw1kW6r9rhAB0bS77UENrW',
    NULL,
    'fan1@example.com',
    4
  ),
(
    9,
    'fantwo',
    '$2y$12$.UskaHn.KogdTCSsVeJZWO3nFF/w9Af/jYHprVfQosdVMlKaaKWmq',
    NULL,
    'fan2@example.com',
    4
  ),
(
    10,
    'fanthree',
    '$2y$12$E.v0O0KheWJuMi8GgGBAje8iyS.FQr083DFcz8C5L5GWzmQT0EvqS',
    NULL,
    'fan3@example.com',
    4
  ),
(
    11,
    'superone',
    '$2y$12$uBBAzv/C9FdNHOHBJaUnae841.7rsAG6uOD7vnZudrqf2twwFmF7m',
    NULL,
    'superfan1@example.com',
    3
  ),
(
    12,
    'supertwo',
    '$2y$12$Kgoyou1sK/6VZjGFCXuPf.binJ4MItAzi18UYs/jgTwo7wvNRGGUm',
    NULL,
    'superfan2@example.com',
    3
  ),
(
    13,
    'superthree',
    '$2y$12$DTRMEovcTjIZ5iPnhv84Jezfuf9EjvRcqqseajNBTtzLwVLYlOfFS',
    NULL,
    'superfan3@example.com',
    3
  ),
(
    14,
    'superfour',
    '$2y$12$WhM1/VdUBJMtpdvru2rLBOjIfz/a2klHZgX9ZgftOa.YjdWYagTQ2',
    NULL,
    'superfan4@example.com',
    3
  ),
(
    15,
    'superfive',
    '$2y$12$W5RAJFWbBHPoggSlNnItnuqmkkDqIqbflMHAr6gpE7LR7go6XznTy',
    NULL,
    'superfan5@example.com',
    3
  ),
(
    16,
    'artistaone',
    '$2y$12$Z1tSBdsiLXQ21fFa7Sb3JuKKi0wBS9ypPkrYmCdNJY5ZMg5m1gwBy',
    NULL,
    'artista1@example.com',
    2
  ),
(
    17,
    'artistatwo',
    '$2y$12$GGK3KdRux2f1wfvnFoRiX.T9MKiUiXkV3mNDw/oF3OzgYL6gq9XU6',
    NULL,
    'artista2@example.com',
    2
  ),
(
    18,
    'artistathree',
    '$2y$12$kQl4AagKtUNmSBf2Ww8CNOUFb19hiPrDJj3ye34bBAeX4F640UpR2',
    NULL,
    'artista3@example.com',
    2
  ),
(
    19,
    'artistafourt',
    '$2y$12$E9tYLkJeYXFf.Z24KMzYJOsGergJkT1qbDZFOGjp3srZ1UpLQE8Ni',
    NULL,
    'artista4@example.com',
    2
  );
...
;
-- Dump completed on 2024-10-17 11:32:36