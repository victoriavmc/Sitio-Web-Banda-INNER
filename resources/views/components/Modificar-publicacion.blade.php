                        ...
                        <div class="border-2 border-black p-4 rounded-xl grid grid-cols-3 gap-4">
                            ...
                            @foreach ($imagenes as $imagen)
                                <div class="relative" data-imagen-id="{{ $imagen->idimagenes }}">
                                    ...
                                    <input type="hidden" name="imagenesEliminadas[]" value="{{ $imagen->idimagenes }}"
    ...
    <script>
        document.querySelectorAll('.eliminar-imagen').forEach(boton => {
            boton.addEventListener('click', function() {
                ...
                inputEliminar.value = ''; // Marcar para eliminar
