        ...
        <table class="w-full table-fixed">
            <thead>
                <tr class="bg-gray-100">
                    <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase">Muestra</th>
                    <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase">Titulo Album</th>
                    <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase">Fecha Album</th>
            ...
            <tbody class="bg-white">
                ...
                @foreach ($albumInfo as $item)
                    <tr>
                        ...
                        <td class="py-4 px-6 border-b border-gray-200">{{ $item['tituloAlbum'] }}</td>
                        <td class="py-4 px-6 border-b border-gray-200 truncate">{{ $item['fechaAlbum'] }}</td>
