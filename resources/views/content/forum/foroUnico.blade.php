        ...
        <div>
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="max-w-3xl mx-auto">
                    <!-- Foro cabecera -->
                    <div>
                        <h1 class="text-7xl text-black font-bold mt-6 mb-4">{{ $recuperoPublicacion->titulo }}</h1>
                        <p class="text-black text-base mb-4">Publicado el: {{ $recuperoPublicacion->fechaSubida }}</p>
                    </div>

                    <!-- Foro contenido -->
                    <div class="prose text-black text-lg prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto">
                        {{ $recuperoPublicacion->descripcion }}
                    </div>
                    <!-- Imagen Principal -->
                    <div class="flex justify-center">
                        @if ($listaPublicacionConImg && count($listaPublicacionConImg) > 0)
                            <img src="{{ asset(Storage::url($listaPublicacionConImg[0])) }}" class="max-w-full my-4"
                                alt="ImagenForo">
                        @endif
                    </div>
                ...
                <div class="flex flex-row space-x-1 gap-2 items-center">
                    <div
                    ...
                    <div
                        class="bg-black shadow-lg shadow- shadow-black text-white cursor-pointer px-3 py-1 text-center justify-center items-center rounded-xl flex space-x-2 flex-row">
                        REPORTAR
                    </div>
                </div>
            </div>
            ...
            <div class="w-full flex justify-center">
                <div
                    class="w-full max-w-2xl my-4 flex flex-col items-start space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6 lg:px-4 lg:py-8 border-2 border-dashed border-gray-400 dark:border-gray-400 shadow-lg rounded-lg">
                    <span
                        class="text-xs font-medium text-black top-0 left-0 rounded-br-lg rounded-tl-lg px-2 py-1 bg-primary-100 dark:bg-gray-900 dark:text-black border-gray-400 dark:border-gray-400 border-b-2 border-r-2 border-dashed">
                        Usuario
                    </span>
