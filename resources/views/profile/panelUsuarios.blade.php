                                        ...
                                        <td
                                            ...
                                            <div class="xl:absolute inline-block">
                                                ...
                                                <div class="absolute right-0 z-50 rounded-xl hidden bg-white shadow-lg mt-2 transition-all duration-300"
                                                    ...
                                                    <form action="{{ route('borrar-imagen', $usuario->idusuarios) }}"
                                ...
                                @else
                                    <tr>
                                        <td colspan="8" class="p-4 align-middle text-center">
                                            <p class="text-sm font-medium text-zinc-950">No se encontraron usuarios</p>
                                        </td>
                                    </tr>
                                @endif
                            @endforeach
                        ...
                        <div id="especialidad-container" class="mb-4 hidden">
                            ...
                            <select id="especialidad" name="especialidad"
                                ...
                                @foreach ($especialidades as $especialidad)
                                    <option value="{{ $especialidad->idtipoStaff }}">{{ $especialidad->nombreStaff }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
