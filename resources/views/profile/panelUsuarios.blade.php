                                        ...
                                        @if ($usuario->idusuarios)
                                            <tr
                                                ...
                                                <td
                                                    ...
                                                    <a href="{{ route('perfil-ajeno', $usuario->idusuarios) }}">
                                                        <p
                                                            class="text-sm font-medium {{ $usuario->datosPersonales->historialUsuario->first()->estado === 'Baneado' || 'Suspendido' ? 'text-red-500' : 'text-zinc-950' }}">
                                ...
                                <select id="especialidad" name="especialidad"
                                    ...
                                    @foreach ($especialidades as $especialidad)
                                        <option value="{{ $especialidad->idtipoStaff }}">
                                            {{ $especialidad->nombreStaff }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <!-- Botones -->
