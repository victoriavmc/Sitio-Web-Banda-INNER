<x-AppLayout>
    ...
    <div class="min-h-screen">
        ...
        <div class="container mx-auto max-w-4xl mt-10 border-b border-gray-300 pb-3">
            ...
            @endauth
            @if (!$listaAlbum)
                <p class="text-center text-2xl text-gray-500">No hay albums disponibles
                </p>
            @else
                                        ...
                                        @foreach ($listaAlbum as $album)
                                            <div class="flex w-full justify-center gap-12">
                                                <div class="max-w-sm border border-gray-300 flex">
                                                    @auth
                                                        <div class="flex gap-3 absolute pl-3 pt-3">
                                                            <form action="{{ route('eliminar-album', $album['id']) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
                                                            ...
                                                            <div class="relative">
                                                                <nav class="flex min-w-[240px] flex-col gap-1 py-1.5">
                                                                    <div role="button"
                                                                        ...
                                                                        <div
                                                                            class="text-black flex w-full items-center gap-1">
